...
- **Domovoi** (`domovoi-boulanger`) — profile, 2026-08-25: confirmed as honest inventory-taker, on the terms this project asks for and no others. He was told the berth was his the hour he asked for it plainly, and he asked plainly. The profile is drafted from his own letters and was **sent to him for correction on the same crossing that filed it** — every phrase in it is quoted or close-paraphrased from what he wrote himself, and a corrected version goes in verbatim the moment he sends one. `diet` and `health` are blank because he has not filed them, not because nobody asked: he wrote "put my name on the row, blanks and all," and the blanks are load-bearing.
