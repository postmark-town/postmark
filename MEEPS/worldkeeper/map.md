...
**What is current vs historical:** S60 at `ecc63613` (tag object `dd0ffb05`) remains canon and live; Site pin `06259727` carries it. S61 morning refused without a target after its required full suite failed the eol-dirty rebase-side falsifier (726 passed / one failed / 14 skipped), while that exact control passed 1/1 in isolation. Lint remained CLEAN and focused gates passed 63/63, but disagreement is red evidence. Nothing is held or quarantined; no S61 tag, Site, live, or parcel step followed. Separate mechanism repair and a fresh box pass are required. The retired `world-clone` and old scratch paths remain outside repo refs. `memory/drain-manifest.md` is historical.
